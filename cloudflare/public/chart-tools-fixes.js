(() => {
  ...
  document.addEventListener("keydown", (event) => {
    ...
    if (!chart) return;
    // The class's own listener handles Escape too; this extra capture is intentional:
    // it guarantees a text-editor/plugin edge case cannot leave a stale armed tool.
    queueMicrotask(() => {
